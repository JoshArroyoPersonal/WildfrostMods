        ...
        private static Dictionary<string, (float, float, float, float, float)[]> eyeDictionary = new Dictionary<string, (float, float, float, float, float)[]>
    {
        ...
        public static void Eyes()
        {
            ...
            List<EyeData> list = new List<EyeData>()
            {
                ...
                Eyes("websiteofsites.wildfrost.pokefrost.sableye", (-0.18f,1.18f,2.70f,2.70f,0f), (0.58f,1.33f,1.80f,2.50f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.salazzle", (0.39f,2.35f,1.50f,0.80f,340f)),
                Eyes("websiteofsites.wildfrost.pokefrost.sharpedo", (0.24f,1.41f,1.30f,1.30f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.slowbro", (0.14f,1.82f,1.40f,1.40f,0f), (0.80f,1.84f,1.40f,1.40f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.slowking", (-0.56f,1.63f,1.20f,1.20f,0f), (-0.20f,1.59f,1.20f,1.20f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.smeargle", (0.10f,1.30f,1.10f,1.10f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.sneasel", (0.14f,1.39f,0.80f,1.00f,0f), (0.52f,1.41f,0.70f,1.00f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.snorlax", (-0.28f,1.20f,1.30f,1.00f,0f), (0.35f,1.22f,1.30f,1.00f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.spheal", (0.37f,1.22f,1.20f,1.20f,0f), (0.81f,1.34f,1.20f,1.20f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.spinda", (-0.33f,1.18f,1.00f,1.00f,0f), (0.45f,1.36f,1.00f,1.00f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.sylveon", (0.33f,1.25f,1.00f,1.30f,0f), (0.75f,1.34f,1.00f,1.30f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.toxicroak", (0.10f,1.73f,1.30f,1.10f,0f), (0.74f,1.77f,1.20f,1.00f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.tyrantrum", (0.75f,1.24f,1.20f,1.20f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.umbreon", (0.76f,1.41f,1.40f,0.80f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.vaporeon", (-0.15f,1.71f,1.20f,1.20f,0f), (0.35f,1.81f,1.20f,1.20f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.volcarona", (0.30f,1.57f,1.10f,0.60f,310f), (0.53f,1.52f,0.80f,0.20f,55f)),
                Eyes("websiteofsites.wildfrost.pokefrost.weezing", (-0.87f,1.42f,1.00f,1.00f,0f), (-0.51f,1.50f,1.00f,1.00f,0f), (0.27f,1.25f,1.50f,1.50f,0f), (0.91f,1.07f,1.40f,1.40f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.whimsicott", (0.04f,1.03f,0.70f,1.40f,0f), (0.44f,1.00f,0.70f,1.40f,0f)),
                Eyes("websiteofsites.wildfrost.pokefrost.xatu", (0.05f,1.90f,1.70f,1.10f,0f)),
